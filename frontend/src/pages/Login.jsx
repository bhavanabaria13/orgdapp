    ...
    <div className="min-h-[calc(100vh-16rem)] flex items-center justify-center px-4 py-16 relative">
      ...
      <div className="relative glass rounded-3xl p-8 md:p-10 w-full max-w-md" data-testid="login-card">
        <div className="flex items-center gap-2 mb-6">
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-purple-600">
            <Hexagon className="h-5 w-5 text-white" />
          </span>
          <div>
            <div className="font-heading font-black">EtherAuthority</div>
            <div className="text-[10px] tracking-[0.24em] text-purple-300/80 -mt-0.5">ADMIN LOGIN</div>
          </div>
        </div>
